    ...
    <div style={{ backgroundColor: "#F5D56E", minHeight: "100vh", overflowY: "auto", position: "relative" }}>
        ...
        >
            ...
            <Toolbar sx={{ mt: 2 }}>
                        ...
                        <Typography
                            variant="h3"
                            sx={{ fontFamily: 'Lato', fontWeight: '900', fontSize: { xs: '25px', md: '30px' }, color: '#B18A00', flexGrow: 1 }}
                        >
                            EduDeck
                        </Typography>
                        <Box 
                    ...
                    <Typography style={{ fontFamily: 'Lato', fontWeight: 'bolder', color: '#B18A00', fontSize: '35px', marginRight: '12px'}}>EduDeck</Typography> 
                    <Typography style={{ fontFamily: 'Lato', fontWeight: 'bolder', color: '#332D2D', fontSize: '35px'}}>Plus</Typography>
                    </Box>
                    <Box sx={{ width: {xs: '70%', md: 'auto'}, position: 'relative', top: {xs: '6%', md: '2%'}, left: {xs: '50%', md: '54%'}, transform: 'translate(-50%, -50%)', textAlign: 'center' }}>
                        <Typography sx={{ fontFamily: 'Lato', fontWeight: 'bold', color: '#332D2D', fontSize: { xs: '20px', md: '20px' }, flexGrow: 1,}}>Excel in your courses using our latest set of study resources.</Typography>
                    </Box>
                  ...
                  >
                    <Box
                    sx={{
                      backgroundColor: '#FAC712', padding: '10px', borderRadius: '15px', position: 'absolute', top: { xs: '35px', md: '35px' }, right: { xs: '178px', md: '740px' }, zIndex: 5, fontFamily: 'Lato', fontWeight: 'bold', width: '95px', textAlign: 'center',
                    }}
                  >
                    BEST DEAL!
                  </Box>
                    ...
                    <Grid item xs={12} md={6} sx={{ pr: { md: 5 } }}>
                      ...
                      >
                        <Typography
                          sx={{ fontFamily: 'Lato', fontWeight: 'bolder', color: '#B18A00', fontSize: { xs: '30px', md: '30px' }, textAlign: 'left', marginBottom: '25px', marginTop: '20px',
                          }}
                        >
                          Free Plan
                        </Typography>
                        <Typography
                            sx={{ fontFamily: 'Lato', color: '#9FA0A0', fontSize: { xs: '18px', md: '15px' }, textAlign: 'left' }}
                          >
                        ...
                        <Button
                          sx={{ background: '#FAC712', fontFamily: 'lato', fontSize: { xs: '18px', md: '20px' }, fontWeight: 'bold', color: '#555245', marginTop: '35px', textTransform: 'none', padding: '10px', borderRadius: '10px', width: '100%', boxShadow: '0px 2px 8px rgba(0, 0, 0, 0.2)',
                    ...
                    <Grid item xs={12} md={6} sx={{ pr: { md: 5 } }}>
                      ...
                      >
                        <Typography
                          sx={{ fontFamily: 'Lato', fontWeight: 'bolder', color: '#B18A00', fontSize: { xs: '30px', md: '30px' }, textAlign: 'left', marginBottom: '5px',
                          }}
                        >
                          EduDeck Plus 
                        <Typography
                          sx={{ fontFamily: 'Lato', fontWeight: 'bolder', color: '#B18A00', fontSize: { xs: '30px', md: '20px' }, textAlign: 'left', marginBottom: '25px',
                          }}
                        >
                          (₱30/month): 
                        </Typography>
                        ...
                        <Button
                          sx={{ background: '#332D2D', fontFamily: 'Lato', fontSize: { xs: '18px', md: '20px' }, fontWeight: 'bold', color: '#FAC712', marginTop: '20px', textTransform: 'none', padding: '10px', borderRadius: '10px', width: '100%', boxShadow: '0px 2px 8px rgba(0, 0, 0, 0.2)',
